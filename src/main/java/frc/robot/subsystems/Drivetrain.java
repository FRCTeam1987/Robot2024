...
public class Drivetrain extends SwerveDrivetrain implements Subsystem {
  ...
  private void configurePathPlanner() {
    ...
    AutoBuilder.configureHolonomic(
        ...
        // this::seedFie]ldRelative,  // Consumer for seeding pose against auto
        this::resetPose,
        ...
        () ->
            DriverStation.getAlliance().orElse(Alliance.Blue)
                == Alliance.Red, // Change this if the path needs to be flipped on red vs blue
  ...
  public void resetPose(final Pose2d newPose) {
    DriverStation.reportWarning("Before: " + getPose().toString(), false);
