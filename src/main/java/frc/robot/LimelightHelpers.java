...
public class LimelightHelpers {
    ...
    /**
    * Calculates the distance from the Limelight to the target based on the
    * vertical angle and the known heights of the camera and the target.
    *
    * @param limelightName The network table name of the Limelight to query.
    ...
    */
    public static double calculateDistanceToTarget(double ty, double cameraHeight, double targetHeight, double cameraAngle) {
